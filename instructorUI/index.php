                        ...
                        <div id="ILOs" class="tabcontent">
                            ...
                            <div id="containerPlan">
                                ...
                                <div class="planCard" data-subject-code="">
                                    <a href="edit_insert_syllabus.php" style="display: block; width: 100%; height: 10%; text-decoration: none; color: inherit;">
                                        ...
                                        <div style="text-align: center; font-size: 16px; color: #555; margin-top: 150px;">
                                ...
                                <div class="planCard" data-subject-code="">
                                    <a href="insert_competencies.php" style="display: block; width: 100%; height: 10%; text-decoration: none; color: inherit;">
